...
dataset = "Bharatmart_Sales_Model_SQL" # Enter the name or ID of the semantic model
workspace = "Bharatmart_Bootcamp_Adarsh" # Enter the workspace name or ID in which the semantic model exists
